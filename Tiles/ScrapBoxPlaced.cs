...
namespace ALMusic.Tiles
{
    class ScrapBoxPlaced : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            DustType = AL != null ? AL.Find<ModDust>("DoomDust").Type : DustID.WoodFurniture;
            AddMapEntry(new Color(200, 200, 200), name);
            RegisterItemDrop(ModContent.ItemType<ScrapBox>(), 1);
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<ScrapBox>();
        }
